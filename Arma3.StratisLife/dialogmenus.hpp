...
class BankMenu
{
	...
	class Withdraw : BaseRscButton
	{
		idc = 11118;
		text = "Withdraw";
		action = "execVM 'withdrawmoney.sqf'";
		x = 0.65; y = 0.425;
		w = 0.5;
	};
	class Deposit : BaseRscButton
	{
		idc = 11119;
		text = "Deposit";
		action = "execVM 'depositmoney.sqf'";
		x = 0.65; y = 0.5;
		w = 0.5;
	};
	class Transfer : BaseRscButton
	{
		idc = -1;
		text = "Wire Transfer";
		action = "closeDialog 0, execVM 'transfermenu.sqf'";
		x = 0.65; y = 0.575;
		w = 0.5;
	};
	class Close : BaseRscButton
...
class HeroinProMenu
{
	...
	class Process : BaseRscButton
	{
		...
		action = "execVM 'heroinprocess.sqf'";
		x = 0.65; y = 0.350;
		w = 0.5;
	};
		class HeroinprocessLicense : BaseRscButton
	{
		...
		action = "if((player getVariable 'heroinprocesslicense') >= 1) then{}else{if((player getVariable 'mymoney') >= 5000) then{player setVariable['mymoney',((player getVariable 'mymoney') - 5000)]; player setVariable['heroinprocesslicense',1];}};closeDialog 0; execVM 'heroinpromenu.sqf';";
		x = 0.65; y = 0.500;
		w = 0.4;
	};
...
class MarketMenu
{
	...
	controlsBackground[] = {Background};
	objects[] = {};
	controls[] = {Title,FishMenu,AppleMenu,Close};
...
class BankTransferMenu
{
	...
	class Transfer : BaseRscButton
	{
		idc = 11167;
		text = "Transfer";
		action = "execVM 'transfermoney.sqf'";
		x = 0.65; y = 0.575;
		w = 0.5;
	};
	class Close : BaseRscButton
	{
		idc = -1;
		text = "Close";
		action = "closeDialog 0, execVM 'bankmenu.sqf'";
		x = 0.65; y = 0.650;
		w = 0.5;
	};
};
