...
hint format["You need 2000 $ to buy this! You have %1 $!",(player getVariable "mymoney")];
} else {
if ((player getVariable "terrorlicense") < 1) then {
hint "You need a Terrorlicense to buy this!";
} else {
terrorbox addMagazineCargo ["30Rnd_65x39_caseless_green",5];
player setVariable ['mymoney',(player getVariable "mymoney") - 2000];
hint format["You bought the Ammo for 2000 $! You have %1 $ left!",(player getVariable "mymoney")];
};
};
} else {
