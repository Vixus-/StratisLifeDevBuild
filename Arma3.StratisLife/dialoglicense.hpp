class CivLicenseMenu
{
	...
	controlsBackground[] = {};
	objects[] = {};
	controls[] = {Title,InfoT,CostT,DriverLicense,Info1,Cost1,GunLicense,Info2,Cost2,AirLicense,Info3,Cost3,BoatLicense,Info4,Cost4,OilprocessLicense,Info6,Cost6,Close};
class Title : BaseRscSingleText
	...
	class GunLicense : BaseRscButton
	{
		...
		action = "if((player getVariable 'gunlicense') >= 1) then{}else{if((player getVariable 'mymoney') >= 15000) then{player setVariable['mymoney',((player getVariable 'mymoney') - 15000)]; player setVariable['gunlicense',1]; }};closeDialog 0;execVM 'licensemenu.sqf';";
		x = 0.65; y = 0.350;
		w = 0.4;
	};
